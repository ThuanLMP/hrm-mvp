...
export function useAuthenticatedBackend() {
  ...
  const authenticatedBackend = {
    ...
    region: {
      ...
      create: (data: any) =>
        backend.region.create({ ...data, authorization: `Bearer ${token}` }),
    ...
    bonus: {
      ...
      create: (data: any) =>
        backend.bonus.create({ ...data, authorization: `Bearer ${token}` }),
      approve: (data: any) =>
        backend.bonus.approve({ ...data, authorization: `Bearer ${token}` }),
      reject: (data: any) =>
        backend.bonus.reject({ ...data, authorization: `Bearer ${token}` }),
    },
    training: {
      ...
      createCourse: (data: any) =>
        backend.training.createCourse({
          ...data,
          authorization: `Bearer ${token}`,
        }),
      enrollEmployee: (data: any) =>
        backend.training.enrollEmployee({
          ...data,
          authorization: `Bearer ${token}`,
        }),
    },
    recruitment: {
      ...
      createJobPosting: (data: any) =>
        backend.recruitment.createJobPosting({
          ...data,
          authorization: `Bearer ${token}`,
        }),
      createCandidate: (data: any) =>
        backend.recruitment.createCandidate({
          ...data,
          authorization: `Bearer ${token}`,
        }),
      createInterview: (data: any) =>
        backend.recruitment.createInterview({
          ...data,
          authorization: `Bearer ${token}`,
        }),
    },
